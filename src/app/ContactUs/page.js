  ...
  return (
    <section className="flex flex-col h-auto w-screen">
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row w-auto h-auto md:my-10 shadow-xl">
          {/* Left Column */}
          ...
          {/* Right Column */}
          <div className="bg-[#335c98] text-slate-300 p-8 w-full md:w-2/3 flex flex-col gap-6 lg:flex-row justify-between h-auto">
            <div className="flex flex-col">
              <div className="flex flex-col">
                <h1 className="text-4xl mb-6 poppins-bold">
                  Write Us a Message
                </h1>
                <p className="mb-6 nunito">
                  We’d love to hear from you! Whether you have questions about
                  our stainless steel products, need a quotation, or just want
                  to say hello, feel free to reach out. Your thoughts are
                  important to us, and we’re here to help with anything you
            ...
            <div className="hidden md:inline-block h-[2px] xl:h-[450px] w-[350px] xl:w-0.5 self-stretch bg-neutral-100 dark:bg-white/10" />
