...
export const metadata = {
  ...
  name: "viewport",
  icon: "./favicon.ico", // add this line to reference the favicon
  ...
  keywords: [
    ...
    "glass railing design for balcony in india",
    "modern balcony glass railing",
    "mumbai stainless steel industries",
    ...
    "queue manager",
    "ss wire rope",
    "stainless steel accessoris",
    "balsustrade railing",
    "stainless steel baslustrade railing",
    "glass railing",
    "balcony railing",
    "windows",
    "balcony railing",
