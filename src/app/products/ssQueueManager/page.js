...
//     RAJGURU
//     <br />
//     <p className=" text-xs md:text-base w-[18rem] md:w-[70rem] din-regular pt-2 md:pt-4 text-gray-300">
...
//         <p className=" text-slate-600 text-xs lg:text-sm text-justify  p-8">
